...
\begin{itemize}
    ...
    gli accelerometri e processati direttamente dalla libreria \emph{CoreMotion}\footnote{\emph{CoreMotion} page on Apple's website: 
    ...
    grazie alla libreria \emph{CoreLocation}\footnote{\emph{CoreLocation} page on Apple's website: 
