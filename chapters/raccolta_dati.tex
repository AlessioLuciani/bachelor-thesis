...
flusso di operazioni di raccolta è mostrata nella figura 
\ref{flow_diagram_raccolta_dati}) di natura time-series. In particolare, questi dati
...
\begin{figure}[]
    ...
    \label{flow_diagram_raccolta_dati}
\end{figure}
