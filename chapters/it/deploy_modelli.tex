...
tutte le funzioni principali, modificando la sintassi di base. Ovvero, 
sono stati modificati gli scope di Python basati su indentazione, in scope
C-like, formati da parentesi graffe. % TODO: go on here...

% map list of differences in previous section to actual chosen implementation

% explain inout and how it works with addresses
